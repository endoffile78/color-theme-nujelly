...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(rainbow-delimiters-depth-1-face ((,class (:foreground ,ujelly-fg))))
   `(rainbow-delimiters-depth-2-face ((,class (:foreground ,ujelly-yellow-1))))
   `(rainbow-delimiters-depth-3-face ((,class (:foreground ,ujelly-purple-0))))
   `(rainbow-delimiters-depth-4-face ((,class (:foreground ,ujelly-orange-0))))
   `(rainbow-delimiters-depth-5-face ((,class (:foreground ,ujelly-red-1))))
   `(rainbow-delimiters-depth-6-face ((,class (:foreground ,ujelly-yellow-0))))
   `(rainbow-delimiters-depth-7-face ((,class (:foreground ,ujelly-purple-1))))
   `(rainbow-delimiters-depth-8-face ((,class (:foreground ,ujelly-green-0))))
   `(rainbow-delimiters-depth-9-face ((,class (:foreground ,ujelly-blue-0))))
